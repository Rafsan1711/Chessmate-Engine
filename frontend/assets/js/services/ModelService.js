// WASM ফাইলগুলো CDN থেকে লোড হবে (লোকাল পাথ ইস্যু এড়াতে)
ort.env.wasm.wasmPaths = "https://cdn.jsdelivr.net/npm/onnxruntime-web@1.17.0/dist/";

// মডেল পাথ (index.html এর সাপেক্ষে)
...
class ModelService {
    ...
    async loadModel(statusCallback) {
        ...
        try {
            ...
            if (error.message.includes("404")) msg = "Error: 'assets/chess_model.onnx' not found.";
    ...
    async getBestMove(game) {
        if (!this.modelLoaded) {
            // মডেল না থাকলে র‍্যান্ডম মুভ (যাতে গেম হ্যাং না করে)
